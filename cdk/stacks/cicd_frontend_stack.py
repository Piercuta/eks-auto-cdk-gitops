...
class CICDFronendStack(Stack):
    ...
    def _create_front_end_pipeline(self):
            ...
            environment=codebuild.BuildEnvironment(
                ...
                environment_variables={
                    "VITE_API_URL": codebuild.BuildEnvironmentVariable(
                        value="https://" + self.config.dns.backend_domain_name
                    ),
        ...
        source_action = codepipeline_actions.CodeStarConnectionsSourceAction(
            ...
            owner=self.config.cicd_fronend.github_owner,
            repo=self.config.cicd_fronend.github_frontend_repo,
            branch=self.config.cicd_fronend.github_frontend_branch,
            connection_arn=self.config.cicd_fronend.github_connection_arn,
