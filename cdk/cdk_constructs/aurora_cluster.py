...
class AuroraCluster(Construct):
    ...
    def _create_manage_master_user_password_lambda(self, cluster: rds.DatabaseCluster) -> lambda_.Function:
        ...
        lambda_log_group = logs.LogGroup(
            ...
            log_group_name=f"/{self.config.project_name}/{self.config.env_name_str}/lambda/{self.config.prefix('manage-master-user-password')}",
        ...
        return lambda_.Function(
            ...
            code=lambda_.Code.from_asset(
                "cdk_constructs/aurora_cluster_lambda",
